...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" onload=todayDate()>
        
        <div id="app">
        <nav class="navbar navbar-expand-sm sticky-top navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><i class="fa fa-graduation-cap"></i>
                UFES
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <nav>
                    <a href="/svhome">Home</a>
                    <a href="/lviewdata">Data Entry</a>
                    <a href="/StdLectViewScheduleForm">Schedule</a>
                    <a href="/svviewrubrichome">Rubric</a>
                    <a href="/svmain">Evaluation</a>
                    <a href="/mainsv">Report</a>
                    </nav>
                    </ul>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class = "footer">Copyright UMP FYP Evaluation System (UFES) 2022. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>
