...
@section('content')
<!-- Add Marks Evalutor view -->
<title>Add Marks Second Evaluation</title>
...
<form action="/markedlist2" method = "post" >
            @csrf
<div class="container">
    <div class="row">
        <div class="col-5">
            <br>
            <p style = "font-size:25px"><b>Second Evaluation Add Marks</b></h2>
            <br><br>
        </div>
