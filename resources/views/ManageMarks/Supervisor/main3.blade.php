...
@section('content')
<!-- Second main page for third evaluation -->
                ...
                <div class="container col-md-4">
                    <div class="card" style=" width: 25rem;">
                        <img style="height:162px " class="card-img-top"
                            ...
                            alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title"><b>Third Evaluation</b></h5>
                            <br>
                            <a href="/unmarkedlist3"><button type="button" class="btn btn-primary" id="first" style=>Unmarked Lists</button></a>
                            <br><br>
                            <a href="/markedlist3"><button type="button" class="btn btn-primary" id="second">Marked Lists</button></a>
                        </div>
                    </div>
                    </div>
                </div>
