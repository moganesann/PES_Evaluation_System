...
<!-- Supervisor third Evaluation Update Marks -->
<style>
    .container {
        margin: 80px;
        margin-top: 5px;
...
<!-- Student Details print -->
        ...
        <!-- Rubric details according to evalution type and course type -->
        <div class="row">
            <div class="col-md-10">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <input style="width:50px;" name="marksev2" type="text" class="form-control form-control-sm"
                            id="marksev2" value="{{ $row->marksev2 }}" required readonly>
                        </input>
                ...
                <tr>
                    <td>
                        ...
                        <span style="color:red">@error('marksev3'){{ $message }} @enderror</span>
                        </input>
