...
<title>Update Marks First Evaluation</title>

<style>
</style>
<!-- Supervisor First Evaluation Update Marks -->
...
<div class="container">
    <div class="row">
        <div class="col-5">
            <br>
            <p style = "font-size:25px"><b>First Evaluation Update Marks</b></h2>
            <br><br>
        </div>
<!-- Student Details -->
        <div class="col-md-12">
        ...
        <!-- Rubric according to course and evaluation type -->
        <div class="row">
            <div class="col-md-10">
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="width:50px;" name="marksev1" type="text" class="form-control form-control-sm"
                                    id="marksev1" value="{{ $row2->marksev1 }}" required> <p>/30</p>
