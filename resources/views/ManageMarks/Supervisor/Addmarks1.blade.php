...
@section('content')
<!-- Add Marks Supervisor view First Evalution-->
<title>Add Marks First Evaluation</title>
...
<form action="/markedlist1" method = "post" >
            @csrf
<div class="container">
    <div class="row">
        <div class="col-5">
            <br>
            <p style = "font-size:25px"><b>First Evaluation Add Marks</b></h2>
            <br><br>
        </div>
<!-- Print Student Details-->
        ...
        @foreach ($data as $row)
            ...
            <div class="mb-3 row">
                ...
                id="ev_id" placeholder="Evaluation ID" value="{{ $ev_id }}" readonly>
                </input>     
            </div>
            <br> 
            </div> 
        ...
        <!-- Print Rubrics according to course type and evaluation type-->
        <div class="row">
            <div class="col-md-10">
                        ...
                        <tr>
                            <td>
                                <input style="width:50px;" name="marksev1" type="text" class="form-control form-control-sm"
                                    id="marksev1" required> <p>/30</p>
                                <span style="color:red">@error('marksev1'){{ $message }} @enderror</span>
                                </input>
